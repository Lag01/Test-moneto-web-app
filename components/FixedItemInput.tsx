...
export default function FixedItemInput({
  ...
  return (
    <div className="space-y-1">
      <div
        className={`flex items-center gap-3 p-3 rounded-lg border ${borderColor} ${bgColor} dark:bg-opacity-20 transition-all duration-200 hover:shadow-md ${
      ...
      >
        ...
        <div className="flex-1">
          <input
            ...
            autoFocus={autoFocus}
            className={`w-full px-3 py-2 bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded focus:outline-none focus:ring-2 focus:ring-${
        ...
        <div className="w-32">
          <input
            ...
            min="0"
            step="0.01"
            className={`w-full px-3 py-2 bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded text-right focus:outline-none focus:ring-2 focus:ring-${
              type === 'income' ? 'green' : 'red'
        ...
        {!isEditing && parseFloat(amount) > 0 && (
          <div className={`text-sm font-medium ${textColor} dark:opacity-90 w-24 text-right`}>
        ...
        <button
          onClick={() => onDelete(id)}
          className="p-2 text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 hover:bg-red-100 dark:hover:bg-red-900/30 rounded transition-colors"
          title="Supprimer"
        >
          <svg
            className="w-5 h-5"
