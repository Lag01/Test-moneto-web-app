...
export default function NotificationBanner({ notification, onDismiss }: Props) {
  const getStyles = () => {
    switch (notification.type) {
      ...
      case 'warning':
        return 'bg-orange-50 dark:bg-orange-900/20 border-orange-500 text-orange-800 dark:text-orange-200';
      case 'info':
        return 'bg-blue-50 dark:bg-blue-900/20 border-blue-500 text-blue-800 dark:text-blue-200';
      case 'success':
        return 'bg-emerald-50 dark:bg-emerald-900/20 border-emerald-500 text-emerald-800 dark:text-emerald-200';
      default:
  ...
  return (
    <div className={`border-l-4 p-4 rounded-r-lg ${getStyles()}`}>
          ...
          <div className="flex-1">
            ...
            {notification.action && (
              <Link
                ...
                className="inline-block mt-3 px-4 py-2 bg-white/20 hover:bg-white/30 dark:bg-black/20 dark:hover:bg-black/30 rounded font-medium text-sm transition-colors"
              >
